...
public class Game 
{
	...
	public void startPlay() 
	{
		...
		while( player.getHasLifes() && !questions.isEmpty())
		{
			...
			givenAnswer = nextRound(); // Stellt dem Spieler eine zuf�llige Frage, zeigt ihm Antworten, fragt ihn nach einer Antwort, kontrolliert ob die Antworte richtig oder falsch ist und liefert das Ergebnis als booleschen Wert zur�ck.
			player.changeLifes(givenAnswer); // Ver�ndert das Leben des Spieler je nach Antwort (richtig oder falsch).
